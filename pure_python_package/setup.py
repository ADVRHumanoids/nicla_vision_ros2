...
setup(
    ...
    data_files=[
        ...
        (os.path.join('share', package_name, 'config'), glob(os.path.join('config/rviz', '*.rviz'))),
        (os.path.join('share', package_name, 'config'), glob(os.path.join('config', '*.yaml'))),
        (os.path.join('share', package_name, 'urdf'), glob(os.path.join('urdf', '*.xacro'))),
        (os.path.join('share', package_name, 'urdf'), glob(os.path.join('urdf/meshes', '*.stl'))),
        (os.path.join('share', package_name, 'urdf'), glob(os.path.join('urdf/meshes', '*.dae'))),
    ],
    ...
    keywords=['nicla_vision', 'driver', 'arduino_integration', 'nicla_integration'],
    classifiers=[

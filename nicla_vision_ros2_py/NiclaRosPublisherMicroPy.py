...
from nicla_vision_ros2_py import (
    ...
    def __init__(self, rate):
        ...
        if self.enable_range:
            ...
            self.range_msg.field_of_view = (
                0.471239  # 27degrees according to arduino doc
            )
        ...
        if connection_type == "udp":
            self.nicla_receiver_server = NiclaReceiverUDPMicroPy(
                ip,
                port,
            ...
            self.nicla_receiver_server = NiclaReceiverTCPMicroPy(
                ip,
                port,
                enable_range=self.enable_range,
                enable_image=self.enable_camera_raw
